...
And in HelloWorldScene.h/.cpp, there is no need to declare or implement any of the rewarded callback methods:
...
And in HelloWorldScene.h/.cpp, there is no need to declare or implement any of the interstitial callback methods:
